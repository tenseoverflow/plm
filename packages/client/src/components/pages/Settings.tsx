...
import { type HabitSchedule, useAppState } from "@store/index";
  ...
  const handleLoginWithPasskey = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        loginWithPasskey(result.userId, result.name);
  ...
  return (
    <div className="space-y-8">
      <section className="space-y-2">
        <div className="text-neutral-500 text-sm">Week view</div>
      ...
      <section className="space-y-3">
        <div className="text-neutral-500 text-sm">Account & Sync</div>
        <div className="space-y-3 rounded-md border border-neutral-200 p-3 dark:border-neutral-800">
          {auth.isAuthenticated ? (
            ...
            <div className="space-y-3">
              ...
              <div className="border-neutral-200 border-t pt-3 dark:border-neutral-800">
            ...
            <div className="space-y-3">
              ...
              <div>
                <div className="text-neutral-500 text-xs">Your name</div>
                <Input
                  value={name}
      ...
      <section className="space-y-3">
        <div className="text-neutral-500 text-sm">Focus settings</div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="space-y-1">
            <div className="text-neutral-500 text-xs">Pomodoro rounds</div>
            <Input
              type="number"
          ...
          <div className="space-y-1">
            <div className="text-neutral-500 text-xs">Long total minutes</div>
            <Input
              type="number"
          ...
          <div className="space-y-1">
            <div className="text-neutral-500 text-xs">Break every minutes</div>
            <Input
              type="number"
          ...
          <div className="space-y-1">
            <div className="text-neutral-500 text-xs">Break minutes</div>
            <Input
              type="number"
      ...
      <section className="space-y-3">
        <div className="text-neutral-500 text-sm">Habits</div>
        <form
          onSubmit={(e) => {
            e.preventDefault();
